...
description: Fish Identifier privacy policy
---

# Privacy Policy - Fish Identifier

**Effective date:** June 3, 2026  
**Developer:** Mustapha Marir - solo developer based in Morocco  
**Contact:** [marirfam@gmail.com](mailto:marirfam@gmail.com)  
**App package:** `com.marirfam.fishid`

This document explains what Fish Identifier collects, what it does not collect, why data is processed, and which third parties are involved.

---

## 1. What Fish Identifier does not collect
...
- **No cloud sync of your collection.** Saved fish identifications stay on your device.
- **No sale of personal data.** We do not sell user data.

---

## 2. What Fish Identifier does process
...
2. It is sent over HTTPS to our backend proxy at `https://fish-id-worker.marirfam.workers.dev`.
3. The proxy verifies app integrity and forwards the image to Google's Gemini API for fish identification.
...
The app shows ads using Google AdMob. AdMob may process device-level identifiers and ad-performance signals, including the Android Advertising ID, according to Google's policies.
...
Fish Identifier is not directed to children under 13. We do not knowingly collect personal data from children.
...
- **Google Gemini API** - AI-based fish identification
...
- **Subject line:** please include "Fish Identifier privacy"

---

*Fish Identifier is built and supported by one developer.*
