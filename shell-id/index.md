...
description: Shell Identifier privacy policy
---

# Privacy Policy - Shell Identifier

**Effective date:** June 4, 2026  
**Developer:** Mustapha Marir - solo developer based in Morocco  
**Contact:** [marirfam@gmail.com](mailto:marirfam@gmail.com)  
**App package:** `com.marirfam.shellid`

This document explains what Shell Identifier collects, what it does not collect, why data is processed, and which third parties are involved.

---

## 1. What Shell Identifier does not collect
...
- **No cloud sync of your collection.** Saved shell identifications stay on your device.
- **No sale of personal data.** We do not sell user data.

---

## 2. What Shell Identifier does process
...
2. It is sent over HTTPS to our backend proxy for shell identification.
3. The proxy verifies app integrity and forwards the image to Google's Gemini API for identification.
4. The result returns to your phone.
...
To reduce abuse, the app uses Google Play Integrity when sending scan requests. A Play Integrity token is sent with the scan request so the backend can verify that the app installation is genuine.
...
Shell Identifier is not directed to children under 13. We do not knowingly collect personal data from children.
...
- **Google Gemini API** - AI-based shell identification
...
- **Subject line:** please include "Shell Identifier privacy"

---

*Shell Identifier is built and supported by one developer.*
