...
description: Stamp Identifier privacy policy
---

# Privacy Policy - Stamp Identifier

**Effective date:** June 7, 2026  
**Developer:** Mustapha Marir - solo developer based in Morocco  
**Contact:** [marirfam@gmail.com](mailto:marirfam@gmail.com)  
**App package:** `com.marirfam.stampid`

This document explains what Stamp Identifier collects, what it does not collect, why data is processed, and which third parties are involved.

---

## 1. What Stamp Identifier does not collect
...
- **No cloud sync of your collection.** Saved stamp entries stay on your device.
- **No sale of personal data.** We do not sell user data.

---

## 2. What Stamp Identifier does process
...
2. It is sent over HTTPS to our backend proxy for stamp identification.
...
Stamp Identifier is not directed to children under 13. We do not knowingly collect personal data from children.
...
- **Google Gemini API** - AI-based stamp identification
...
- **Subject line:** please include "Stamp Identifier privacy"

---

*Stamp Identifier is built and supported by one developer.*
