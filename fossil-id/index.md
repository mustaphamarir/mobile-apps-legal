...
description: Fossil Identifier privacy policy
---

# Privacy Policy - Fossil Identifier

**Effective date:** June 10, 2026  
**Developer:** Mustapha Marir - solo developer based in Morocco  
**Contact:** [marirfam@gmail.com](mailto:marirfam@gmail.com)  
**App package:** `com.marirfam.fossilid`

This document explains what Fossil Identifier collects, what it does not collect, why data is processed, and which third parties are involved.

---

## 1. What Fossil Identifier does not collect
...
- **No cloud sync of your collection.** Saved fossil identifications stay on your device.
- **No sale of personal data.** We do not sell user data.

---

## 2. What Fossil Identifier does process

### a) Fossil scan images

When you use the scan feature:

1. The image is prepared on your phone.
2. It is sent over HTTPS to our backend proxy at `https://fossil-id-worker.marirfam.workers.dev`.
3. The proxy verifies app integrity and forwards the image to NVIDIA's hosted multimodal model API for fossil identification.
...
Fossil Identifier is not directed to children under 13. We do not knowingly collect personal data from children.
...
- **NVIDIA API / NVIDIA-hosted multimodal model endpoint** - AI-based fossil identification
...
- **Subject line:** please include "Fossil Identifier privacy"

---

*Fossil Identifier is built and supported by one developer.*
